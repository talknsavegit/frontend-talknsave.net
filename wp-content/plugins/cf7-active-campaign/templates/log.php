...
<div class="crm_head_div"><span class="crm_head_text"><?php _e('Data Sent','contact-form-activecamp-crm') ?></span></div>
...
<?php
      ...
      ?>
  <div class="vx_error"><i class="fa fa-warning"></i> <?php _e('Nothing Posted to Active Campaign','contact-form-activecamp-crm');?></div>      
      <?php
  }
?>
</div></div>
    ...
    if(is_array($response) && count($response)>0){
      ...
      ?>
        <div class="crm_panel crm_panel_50">
<div class="crm_panel_head">
<div class="crm_head_div"><span class="crm_head_text"><?php _e('Active Campaign Response','contact-form-activecamp-crm') ?></span></div>
<div class="crm_btn_div" title="<?php _e('Expand / Collapse','contact-form-activecamp-crm'); ?>"><i class="fa crm_toggle_btn fa-minus"></i></div>
<div class="crm_clear"></div>
</div>
<div class="crm_panel_content crm-block-content">
...
<div class="crm_panel_head">
<div class="crm_head_div"><span class="crm_head_text"><?php _e('More Detail','contact-form-activecamp-crm') ?></span></div>
<div class="crm_btn_div" title="<?php _e('Expand / Collapse','contact-form-activecamp-crm'); ?>"><i class="fa crm_toggle_btn fa-minus"></i></div>
<div class="crm_clear"></div>
</div>
<div class="crm_panel_content crm-block-content">
...
?>
 ...
 if($error){
  ?>
<div class="vx_error"><i class="fa fa-warning"></i> <?php _e('Detail Not Found','contact-form-activecamp-crm');?></div>  
  <?php   
 } ?>
...
?>
<a href="<?php echo $feed_link ?>" title="<?php _e('Edit Feed','contact-form-activecamp-crm') ?>" class="button"><i class="fa fa-edit"></i> <?php _e('Edit Feed','contact-form-activecamp-crm') ?></a>
<?php
    }
?>
<a href="<?php echo $log_link ?>" title="<?php _e('Open in New Window','contact-form-activecamp-crm') ?>" target="_blank" class="button"><i class="fa fa-external-link"></i> <?php _e('Open in New Window','contact-form-activecamp-crm') ?></a>
<a href="#" class="button vx_close_detail" title="<?php _e('Close','contact-form-activecamp-crm') ?>"><i class="fa fa-times"></i> <?php _e('Close','contact-form-activecamp-crm') ?></a>
