							...
							<h3 class="psac-header psac-pro-header">4) Premium Shortcodes and Parameters</h3>
								<div class="psac-shortcode-box psac-clearfix">
									<div class="psac-box psac-box-pro">
										<div class="psac-inside-box"> 
											<h4>Ajax Post Filter</h4>
											<p>Add category filter to any layout and filter the content category wise with ajax.</p>
											<input class='large-text' type='text' value='[psac_post_slider filter="true"]' disabled />
											<p><a class="button" href="https://premium.infornweb.com/post-slider-and-carousel-pro-category-ajax-filter/" target="_blank">View Demo</a>  <a class="button" href="<?php echo $upgrade_link; ?>">Upgrade Now</a></p>
										</div>
									</div>
									<div class="psac-box psac-box-pro">
										<div class="psac-inside-box"> 
			...
			<div id="postbox-container-1" class="postbox-container">
				<div class="postbox psac-pro-box">
					...
					<div class="inside">
						<ul class="psac-list">
							<li>30+ Designs</li>							
							<li>Slider and Carousel layouts</li>							
							...
							<li>Post Filtering with Categories <span class="psac-tag">Hot</span></li>
