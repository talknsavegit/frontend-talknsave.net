...
class Psac_Admin {
	...
	function psac_register_menu() {
		...
		// Shortcode Preview
		add_submenu_page( '', __('Shortcode Preview - Post Slider and Carousel', 'post-slider-and-carousel'), __('Shortcode Preview', 'post-slider-and-carousel'), 'manage_options', 'psac-shortcode-preview', array($this, 'psac_shortcode_preview_page') );
	}
