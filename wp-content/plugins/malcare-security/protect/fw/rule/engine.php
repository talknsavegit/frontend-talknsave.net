...
if (!class_exists('MCProtectFWRuleEngine_V585')) :
require_once dirname( __FILE__ ) . '/functions.php';

class MCProtectFWRuleEngine_V585 {
	use MCProtectFWRuleStringFunc_V585;
	use MCProtectFWRuleArrayFunc_V585;
	use MCProtectFWRuleMiscFunc_V585;
	use MCProtectFWRuleRequestFunc_V585;
	use MCProtectFWRuleWPFunc_V585;
	...
	const CONST_NAME_PREFIX = 'MCProtectFWRule_V585::';
	...
	public function evaluate($rule) {
		...
		} catch (MCProtectRuleError_V585 $e) {
			$this->error = $e;
		}
	}
