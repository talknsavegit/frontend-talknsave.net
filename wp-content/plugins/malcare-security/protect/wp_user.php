...
if (!class_exists('MCProtectWPUser_V585')) :
class MCProtectWPUser_V585 {
	public $id;
	public $role;
	public $role_level;
	public $capabilities;
	...
	public static function defaultUser() {
		...
		return (new MCProtectWPUser_V585(0, 0, array(), $time));
	}
	...
	public static function _unserialize($serialized_user) {
		...
		return (new MCProtectWPUser_V585((int) $id, (int) $role_level, $capabilities, (int) $time));
	}
