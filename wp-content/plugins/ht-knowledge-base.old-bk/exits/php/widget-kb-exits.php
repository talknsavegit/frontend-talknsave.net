...
class HT_KB_Exit_Widget extends WP_Widget {
    ...
    */
    function wp_register_scripts(){
        ...
        $ht_exits_frontend_js_src = (HKB_DEBUG_SCRIPTS) ? 'js/ht-exits-frontend.js' : 'js/ht-exits-frontend.min.js';
        wp_register_script( 'ht-exits-frontend', plugins_url( $ht_exits_frontend_js_src, dirname(__FILE__) ), array('jquery'), '1.0.0', true );
