...
/**
 * Plugin Name: Final Tiles Grid Gallery (Envato)
    ...
    class FinalTiles_Gallery
    {
        ...
        public function add_gallery_scripts()
        {
            ...
            if ( ftg_fs()->is__premium_only() ) {
                ...
                wp_register_style( 'swipebox_stylesheet', plugins_url( 'lightbo-pro/swipebox/style.css', __FILE__ ) );
        ...
        public function add_gallery_admin_menu()
        {
            ...
            if ( !class_exists( "EverlightBox" ) ) {
                $everlightbox = add_submenu_page(
                    'ftg-lite-gallery-admin',
                    __( 'FinalTiles Gallery >> EverlightBox', 'FinalTiles-gallery' ),
                    __( 'EverlightBox', 'FinalTiles-gallery' ),
                    'edit_posts',
                    'ftg-everlightbox',
                    array( $this, 'everlightbox' )
                );
