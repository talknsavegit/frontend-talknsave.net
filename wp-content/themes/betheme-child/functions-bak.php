...
function enqueue_custom_script() {
	...
	wp_enqueue_script('custom-script', get_stylesheet_directory_uri(). '/js/custom.js', array('jquery'),'1.1.0',true);
    ...
    wp_enqueue_style('custom-css', get_stylesheet_directory_uri().'/css/custom.css?v=1.05');
