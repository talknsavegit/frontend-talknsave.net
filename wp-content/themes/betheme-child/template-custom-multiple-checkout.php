...
get_header();
// Check if the CartProduct cookie is set
if (isset($_COOKIE['CartProduct'])) {
    // Retrieve the value of the CartProduct cookie
    $cartProductData = $_COOKIE['CartProduct'];
    // Remove escaped double quotes
    $cartProductData = str_replace('\\', '', $cartProductData);
    // Decode the JSON string
    $cartProducts = json_decode($cartProductData, true);
}
...
<script src='https://www.talknsave.net/wp-content/themes/betheme-child/js/multiplePage-checkout.js?ver=21.9.15'></script>
...
$ifWartimePopup = "false";
for ($x = 0; $x < $planCount; $x++) {
    $postObj .= "{";
    $postObj .= "'linkid':" . $linkIDs[$x] . ",";
    $postObj .= "'b':" . $bundleIDs[$x];
    $postObj .= "},";
    if ((($bundleIDs[$x] == "397" || $bundleIDs[$x] == "489" || $bundleIDs[$x] == "513") && ($linkIDs[$x] == "19472" || $linkIDs[$x] == "19471" || $linkIDs[$x] == "19146" || $linkIDs[$x] == "18606" || $linkIDs[$x] == "18605"))) {
        $ifWartimePopup = "true";
    }
}
...
// $ifTrue = "true";
// for ($x = 0; $x < $planCount; $x++) {
//     if(!(($bundleIDs[$x] == "477" || $bundleIDs[$x] == "407") && ($linkIDs[$x] == "17132" || $linkIDs[$x] == "18265"))){
//         $ifTrue = "false";
//         break;
//     }
// }
...
curl_setopt_array($curl, array(
    CURLOPT_URL => 'https://wpapi.talknsave.net/api/products',
...
if (isset($_GET['p'])) {
	...
	if ($p == 'chanukah-2024') {
        $CouponCodeSukkot = "hanukka2024";
    }
    //     if ($p == 'sukkot-2023') {
    //         $CouponCodeSukkot = ""; // Set the CouponCodeSukkot variable
    //     }
...
for ($i = 0; $i < Count($data); $i++) {
    ...
    if ($isCovid_SignupFee == 0 && $data[$i]['Covid_SignupFee'] > 0) {
        $isCovid_SignupFee = $data[$i]['Covid_SignupFee'];
    }
}
// echo "<pre>";
// print_r($allData); die;
...
if ($dataCount == 0) {
    ...
    header("Location: https://www.talknsave.net/custom-multiple-checkout/?b=" . $bundleIDs[0] . "&linkid=" . $linkIDs[0]);
}
...
<div id="Content">
                                        ...
                                        <fieldset id="need_sim">
                                            <div class="row">
                                                ...
                                                <div class="col-md-8 pl-0 pr-0">
                                                    ...
                                                    ?>
                                                        ...
                                                        <div class="parent  pl-3 pr-3 equipmentContainer">
                                                            <div class="cloneSimDefault parentDiv simCount">
                                                                <div class="title">
                                                                    <h2 class="mb-3" style="margin-bottom:0px; display: inline-block;">
                                                                        Please choose your equipment for <?php echo str_replace("<br>", " ", $orderPlanName) ;?> 
                                                                    ...
                                                                    <div class="form-group">
                                                                        <div class="form-check">
                                                                            ...
                                                                            <label class="form-check-label radio-label">
                                                                                ...
                                                                                ?>
                                                                                    <i class="d-none icon-info-circled right-align cursorP simPopup" data-popup='<?php echo $dataPopup; ?>' id="<?php echo $equipment['EquipmentId']; ?>">
                                                                                    </i>
                                                                                <?php }

                                                                                if ($equipment['EquipmentId'] == 3290  || $equipment['EquipmentId'] == 3380 || $equipment['EquipmentId'] == 3390) {
                                                                                ?>
                                                                ...
                                                                ?>
                                                                    <div class="form-group">
                                                                        <div class="form-check">
                                                                            ...
                                                                            <input issmartphone="<?php echo ($equipment['IsSmartPhone']) ? 'true' : ''; ?>" issim="<?php echo ($equipment['IsSim']) ? 'true' : ''; ?>" issns="<?php echo ($equipment['IsSns']) ? 'true' : ''; ?>" kosher="<?php echo ($equipment['kosher']) ? 'true' : ''; ?>" data-cost="<?php echo $equipment['ECost'] ?> " class="form-check-input equipmentSim 1" onclick="AddInsuranceBox();" type="radio" value="<?php echo $equipment['EquipmentId']; ?>" data-code="<?php echo $equipment['EquipmentCode']; ?>" notes="<?php echo ($equipment['Notes']) ? $equipment['Notes'] : ''; ?> " orderNo="<?php echo $i ?>" name="equipment_order_<?php echo $i; ?>" data-name="<?php echo $equipment['name']; ?>" required <?php echo ($countSim == 0) ? checked : ''; ?>>
                                                                            <label class="form-check-label radio-label">
                                                                                <?php echo $equipment['name']; ?>
                                                                                <?php
                                                                                if ($equipment['EquipmentId'] != 9999 && ($equipment['BundlePopUp'] != '')) {
                                                    ...
                                                    <?php } ?>
                                                    <button type="button" name="nextClass next" class="next btn btn-block" id="next2">Next <i class="icon-right-thin"></i></button>
                                                </div>
                                                <div class="col"></div>
                                            </div>
                                        </fieldset>
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="select">
                                                                            <select class="form-control  optionalAdd stay_local stayLocalSelect stayLocalPopup " id="stay_local_order_<?php echo $i; ?>">
                                                                                ...
                                                                                <?php
                                                                                // if ((string)$_GET['linkid'] == "6499" || (string)$_GET['linkid'] == "6499") {
                                                                                // if ((string)$_GET['b'] == "399" || (string)$_GET['b'] == "154") {
                                                                                if ((string)$bundles[0]['Counter'] == "399" ||  (string)$bundles[0]['Counter'] == "154" ||  (string)$bundles[0]['Counter'] == "475") {



                                                                                    foreach ($kntCountries as $kntCountry) :
                                                                            ...
                                                                            <?php echo $kntCountry['DirectDisplayName']; ?>">
                                                                                                <?php echo trim($kntCountry['DirectDisplayName']); ?>
                                                                                            </option>
                                                                                        <?php
                                                                                        }
                                                                                    endforeach;
                                                                                    ...
                                                                                    foreach ($kntCountries as $kntCountry) :
                                                                                        ?>
                                                                                        <option data-kntcode=<?php echo $kntCountry['KNTCode'] ?> data-country="
                                                                            <?php echo $kntCountry['Descr']; ?>" value="
                                                                            <?php echo $kntCountry['DirectDisplayName']; ?>">
                                                                                            <?php echo trim($kntCountry['DirectDisplayName']); ?>
                                                                                        </option>
                                                                            ...
                                                                            <select class="form-control optionalAdd internationalSelect internationalPopup" id="smsPackageName_order_<?php echo $i; ?>">
                                                                                ...
                                                                                ?>
                                                                                    <option class="form-control" value="<?php echo $sms['SMSPackageName']; ?>" smsCode="<?php echo $sms['SmsPackageCode']; ?>">
																						<?php if($sms['SmsPackageCode'] == '1280'): ?>
                                                                                        <?php echo $sms['SMSPackageName'].' -$'.$sms['MonthlyFee']; ?>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-8 pl-3 pr-3">
                                                    ...
                                                    <div class="shipping_option">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="form-check">
                                                                <input class="form-check-input shipping" type="radio" name="shipping_address" value="no" id="differentAddressRadio">
                                                    ...
                                                    <div class="leaving_date" style="display: none;">
                                                        <div class="form-group">
                                                            ...
                                                            <p class="shippingDateError" style="color:red; font-size: 12px; margin-top: -2px;">
                                                            </p>
                                                        </div>
                                                    </div>
                                                    <div class="shipping_info" style="display: none;">
                                                        ...
                                                        <div class="form-group" id="countryInputGroup" style="display: none;>
    <label class=" inner-label">Country <span style="color: red;">*</span></label>
                                                            <input type="text" class="form-control shipping" id="shipCountry" name="shipping_country" readonly>
                                                        </div>
                                                                    ...
                                                                    <div class="cardBody" style="padding: 10px 29px;" ClientCode=" <?php echo $ClientCode; ?>" Deposit=" <?php echo $Deposit; ?>" CouponCode=" <?php echo $CouponCode; ?>" EquipmentCode=" <?php echo $EquipmentCode; ?>" Insurance=" <?php echo $Insurance; ?>" OptionalCode=" <?php echo $OptionalCode; ?>" OptionalFeeDesc=" <?php echo $OptionalFeeDesc; ?>" OptionalImg=" <?php echo $OptionalImg; ?>" OptionalName=" <?php echo $OptionalName; ?>" OptionalType=" <?php echo $OptionalType; ?>" OptionText=" <?php echo $OptionText; ?>" PlanCode=" <?php echo $PlanCode; ?>" RequiredInsurance=" <?php echo $RequiredInsurance; ?>" RequiredOperationSystem=" <?php echo $RequiredOperationSystem; ?>">
                                                                        <div class="imgTitle row">
                                                                            <div class="col-md-3">
                                                                                ...
                                                                                ?>
                                                                                <img class="optional-image" src="<?php echo 'https://checkout.talknsave.net/img/' . $filename; ?>" alt="">
                                                                            </div>
                                                                            <?php
                                                                ...
                                                                <?php foreach ($shipping['shippingAccessories'] as $shippingAss) : ?>
                                                                    ...
                                                                    <div class="card phonecard">
                                                                        <div class="cardBody" style="padding: 10px 29px;" ClientCode=" <?php echo $ClientCode; ?>" Deposit=" <?php echo $Deposit; ?>" CouponCode=" <?php echo $CouponCode; ?>" EquipmentCode=" <?php echo $EquipmentCode; ?>" Insurance=" <?php echo $Insurance; ?>" OptionalCode=" <?php echo $OptionalCode; ?>" OptionalFeeDesc=" <?php echo $OptionalFeeDesc; ?>" OptionalImg=" <?php echo $OptionalImg; ?>" OptionalName=" <?php echo $OptionalName; ?>" OptionalType=" <?php echo $OptionalType; ?>" OptionText=" <?php echo $OptionText; ?>" PlanCode=" <?php echo $PlanCode; ?>" RequiredInsurance=" <?php echo $RequiredInsurance; ?>" RequiredOperationSystem=" <?php echo $RequiredOperationSystem; ?>">
                                                                            <div class="imgTitle row">
                                                                                <div class="col-md-3">
                                                                                    <img style="max-height:60px" class="optional-image" src="<?php echo 'https://checkout.talknsave.net/' . $shippingAss['image']; ?>" alt="">
                                                                                </div>
                                                                                <?php
                                        ...
                                        <fieldset id="card_info">
                                            <div class="row">
                                                ...
                                                <div class="col-md-8 pl-3 pr-3">
                                                    ...
                                                    <h3 class="mt-2" style="margin-top:10px !important;"> Payment Info </h3>
                                                    ...
                                                    <!--                                                     <div class="form-group">
                                                                                                            ...
                                                                                                            <input  max="999"   class="form-control payment cvc"   name="cc_cvc"  oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" type = "number" maxlength = "3"  style="width:100%"> <p  class="errorPayment" style='color:red; font-size: 12px; margin-top: -2px;'></p></div> -->
                                                    <div class="form-group">
                                                    ...
                                                    <div class="mx-4">
                                                        <div class="form-group mt-3 row">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                // 										if (strpos($_GET['b'], '477') !== false || strpos($_GET['b'], '407') !== false) {
                                                                // 											  $CouponCodeSukkot = "winter30";
                                                                // 										}
                                                                ...
                                                                <div class="applyCouponBtn" id="applyCouponBtnoncheckout" style="background-color: green;color: white;">Apply
                                                                </div>
                                            ...
                                            <div class="row order_review d-none">
                                                ...
                                                <div class="col-md-8 pl-3 pr-3 mobile-padding-33">
                                                    ...
                                                    <div class="content">
                                                        ...
                                                        <h4 style="margin-left:-15px">Payment information</h4>
                                                        <div class="row">
                                                            <div class="col-md-6 col-4">Cardholder Name</div>
                                                            <div class="col-md-6 col-8 text-right contact" id="cc_fname">
                                                                ----------</div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-6 col-4">Email</div>
                                                            <div class="col-md-6 col-8 text-right contact" id="paymentEmailAddress">
                                                                ----------</div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-6 col-4">Card Number</div>
                                                            <div class="col-md-6 col-8 text-right contact checkout_credit_card_info" id="credit_card">
                                                                ----------</div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-6 col-4">Card Type</div>
                                                            <div class="col-md-6 col-8 text-right contact" id="cardType">
                                                                ----------</div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-6 col-4">Card Expiration Date</div>
                                                            <div class="col-md-6 col-8 text-right contact" id="expiry_date_review">
                                                                ----------</div>
                                                        </div>
                                                        ...
                                                        <div>
                                                            ...
                                                            <div class="multipleOrderDefault d-none mt-3">
                                                                <div class="row">
    ...
    <div class="form-group agentDiv ml-4" style="
         ...
         width: 105px;
         ">
        <input class="agentName form-control d-none">
    </div>
...
<script>
    ...
    $(document).ready(function($) {
        ...
        //Next click start
        $(document).on('click', '.next , #next2', function() {
            console.log("custom multiple checkout active page tempalte .next here 1900 chil");
            total_forms = $("fieldset").length;
...
console.log("shipping_option");
                ...
                $('.simCount').each(function(index) {
					...
					if (simValue != '9999' && simValue != "3290" && simValue != "3380" && simValue != "3390") {
                    //if (simValue != '9999' && simValue != "3290" && simValue != "3390") {
                        AllalreadyHaveSim++;
                ...
                if (AllalreadyHaveSim == 0) {
					console.log("shipping_option already have sim");
        ...
        $('#next12').click(function() {
            // Optionally, you can call checkAndApplyCoupon on page load to handle pre-filled values
            checkAndApplyCoupon();
        ...
        $('#next9').click(function() {
            ...
            $('.serviceDateContainer').each(function() {
                ...
                if (isEuropePlan != undefined && isEuropePlan != null && isEuropePlan == "1") {
                    ...
                    $('.multipleOrderDefault').parent().find('.parent.newContainer').append('<div class="row  pb-2 border-bottom europeContainer"><div class="col-md-9 ">  <img class="europePlanImage" src="https://checkout.talknsave.net/' + europePlanImg + '" alt="" style="max-width: 65px;">     <span class="europePlanName">' + europePlanName + '</span>  </div><div class="col-md-3 text-right font-weight-bold "> $<span class="europePlanPrice calculate withVat">' + europePlanPrice + '</span> </div> </div> ');
                }
   ...
   $('.calculate.withoutVat').each(function() {
        ...
        $('#next2').click(function() {
            ...
            $('.existing_phone').each(function() {
                ...
                if (cuurentVal.length >= 14 || cuurentVal == '') {
                    if (cuurentVal == '') {
            ...
            var selectedValue = document.querySelector('input[name="equipment_order_0"]:checked').value;
            ...
            //             var isLakewood = false;

            //             $('.serviceDateContainer').each(function(index) {
            //                 if ($(this).attr("sublinkid") == "6499" || $(this).attr("sublinkid") == "1608")
            //                     isLakewood = true;
            //                 else {
            //                     isLakewood = false;
            //                     return false;
...
// 				//debugger;
				...
				$("optgroup[label='USA']").attr('hidden',false);

				$("optgroup[label='Israel']").attr('hidden',false);
				$("#shipping_method option").removeAttr("selected");
                ...
                $('.simCount').each(function(index) {
					...
					console.log("eqipmentId",eqipmentId)
					if(eqipmentId == "3300"){
						$("optgroup[label='Israel']").attr('hidden',false);
						$("optgroup[label='USA']").attr('hidden',true);
					}else if(eqipmentId == "3030"){
						$("optgroup[label='USA']").attr('hidden',true);
						$("optgroup[label='Israel']").attr('hidden',false);
					}else if(eqipmentId == "3070"){
						$("optgroup[label='USA']").attr('hidden',false);
						$("optgroup[label='Israel']").attr('hidden',true);
					}
                    if (shippingID != "-1" &&
                    ...
                    //                     if (isLakewood) {
                    //                         if (eqipmentId == "3070" && baseCode == "5152") currentOption.removeClass('d-none');
                    //                         if (eqipmentId == "3300" && baseCode == "5152") currentOption.removeClass('d-none');
                    //                     }
                    if (eqipmentId == "3300" && baseCode == "5152") currentOption.addClass('d-none');
                    else currentOption.removeClass('d-none');
                    //                     let plan = "<?php echo $p ?>";
            ...
            $('.equipmentContainer').each(function() {
                ...
                if ($(this).find('.simCheckBox').prop("checked")) {
                    ...
                    var isAnyEuropePlan = '<?php echo $isAnyEuropePlan ?>'
                    if ((checkedEquipCode == "3290") && isAnyEuropePlan) {
                        $('.roaming_plans').each(function() {
                            var europeCheckBoxID = $(this).attr('checkboxid');
                            if (europeCheckBoxID.trim() == '312') {
                    ...
                    if (checkedEquipCode == '9999') {
                        ...
                        $(this).closest('.simCount').find('.equipmentSim').each(function() {
                            ...
                            if (isSim == "true" && code != "9999" && code != "3290" && code != "3380" && code != "3390") {
                                checkedEquipCode = code;
                            }

                        });
                        var index = 0;
                        $(mainEquipCOntainer).find('.existing_phone1').each(function() {
                            let simCardNum = $(this).val();
                            simCardNum = simCardNum.replace(/\s/g, '');
                            /*
							 	var extention_value = 0;
								// Get the element with class 'existing_phone'
								var existingPhoneInput = document.querySelector('.existing_phone');
							...
							*/
                            var existingPhoneInput = $(this).closest('.input-group').find('.existing_phone1');
                            var inputGroupTextValue = $(this).closest('.input-group').find('.input-group-text').text();
                            /*
                            						var inputGroup = $(this).closest('.input-group');
                            						var inputGroupText = inputGroup.find('.input-group-text');
                            						var extensionValue = inputGroupText.text();
                            */
                            // 							var extention = $("#phone_extention").val();
                            //                             alreadyHaveSimNums += (index + 1) + ' ' + 'Special Order:Sim Number#: 89972' + simCardNum + '#' + '    ';
                            //  							var order_phone_number = $("#order_phone_id_hidden").val();
                            console.log(simCardNum);
                            alreadyHaveSimNums += (index + 1) + ' ' + 'Special Order:Sim Number#: ' + inputGroupTextValue + simCardNum + '#' + '    ';
                            index++;
                        });
                    }
                    ...
                    $(this).find('.simCount').each(function() {
                        ...
                        if (checkedEquipCode == '9999') {
                            ...
                            $(this).closest('.simCount').find('.equipmentSim').each(function() {
                                let isSim = $.trim($(this).attr('isSim'));
                                let code = $.trim($(this).val());
                                console.log("code on 2932" + code);
                                if (isSim == "true" && code != "9999" && code != "3290" && code != "3380" && code != "3390") {
                                    checkedEquipCode = code;
                                }
                                if ($(this).prop("checked")) {
                                    let simCardNum = $(simCountElement).find(".existing_phone1").val();
                                    simCardNum = simCardNum.replace(/\s/g, '');
                                    // 									 simCardNum = $("#order_phone_id_hidden").val();
                                    if (!alreadyHaveSimNums.includes(simCardNum)) {
                                        ...
                                        var existingPhoneInput = document.querySelector('.existing_phone1');
                                        console.log(simCardNum);
                                        var extention_value = $(existingPhoneInput).closest('.input-group').find('.input-group-text').text();

                                        // 									var order_phone_number = $("#order_phone_id_hidden").val();
                                        alreadyHaveSimNums += (index + 1) + ' ' + 'Special Order:Sim Number#: ' + +extention_value + simCardNum + '#' + '';
                                    }
                                }
                            });
                        }
...
// 				}	
        ...
        $('.begin_date').change(function() {
			...
			console.log("maximumPeriod",maximumPeriod);
        ...
        $('#next8').click(function() {
            ...
            let diffrance = 0;
            let today = 0;
            if (shippingCountry != "Israel") {
                dateTOLeave = $('#date_to_leave').val();
                dateTOLeave = $.trim(dateTOLeave);
                dateTOLeave = new Date(dateTOLeave);
                let dateTOLeavedd = String(dateTOLeave.getDate()).padStart(2, '0');
                let dateTOLeavemm = String(dateTOLeave.getMonth() + 1).padStart(2, '0'); //January is 0!
                let dateTOLeaveyyyy = dateTOLeave.getFullYear();
                dateTOLeave = dateTOLeavemm + '/' + dateTOLeavedd + '/' + dateTOLeaveyyyy;
                ...
                diffrance = Math.ceil(diffTime / (1000 * 60 * 60 * 24));
            }
            ...
            if ($('.schoolName').length > 0 && $('.schoolName').val() == '') {
                ...
                $('.schoolName').focus();
                return false;
                //             } else if ((shippingAddress == 'yes' || shippingAddress == 'no') && billingCountry != shippingCountry) {
            ...
            } else if (shippingCountry != "Israel" && dateTOLeave == today) {
                $('.shippingDateError').text("Please make sure that the delivery date is a future date");
                return false;
            } else if (shippingMethodTitle.includes('Free Delivery') && diffrance < 10) {
                $('.shippingDateError').text('Free shipping is not available when travel date is within ten days, please choose an alternative shipping method');
                return false;
            }
        });
    ...
    async function submitMultiStepForm() {
		...
		//console.log("callPackageCode",callPackageCode);
		...
		//console.log("shippingName",shippingName); return false;
        let shippingId = $('#shipping_method :selected').val();
        let date_to_leave = $('#date_to_leave').val();
        ...
        $('.serviceDateContainer').each(function() {
            ...
            console.log("Equipment code = " + $(this).attr('equipmentcode'));
            console.log(this);
            console.log(ob);
            ...
            if (simVal == "3290" || simVal == "3380" || simVal == "3390") {
                ob.ShipCity = "[eSIM]";
                ob.ShipCommercial = false;
                ob.ShipCountry = "Israel";
                ob.ShipDate = (date_to_leave) ? date_to_leave + " 12:00:00 AM" : start_date;
            ...
            $(this).find('.orderContent').each(function() {
                ...
                // 				SimDetails.EquipmentCode = ob.EquipmentCode ;
                // 				console.log("equipmentcode = "+$(this).attr('equipmentcode')); 
                console.log("equipmentcode = " + ob.EquipmentCode);


                SimDetails.EquipmentModel = $(this).attr('equipmentcode');
                console.log("line 3813 for " + $(this).attr('equipmentcode'));
                // 				SimDetails.EquipmentModel = ob.EquipmentCode;

                console.log("equipment model = " + ob.ShipMethod);

                SimDetails.EquipmentName = $(this).attr('equipment');

                // 				SimDetails.EquipmentName = ob.EquipmentName;

                SimDetails.EquipmentNotes = $(this).attr('equipmentnotes');
                //                   SimDetails.EquipmentNotes = ob.EquipmentCode;
                SimDetails.Insurance = $(this).attr('insuarance') == "Included!" ? true : false;
            ...
            ob.UserCity = "NA";
			var orders_from_type = "<?= $_GET['p']; ?>";
			console.log("orders_from_type",orders_from_type)
			if(orders_from_type == 'partners-usa' || orders_from_type == 'tnsfam-usa'){
				ob.KNTCountryCode = '972';
				ob.bitUSA_SIM_Order = true;
			}
            multiObjescts.push(ob);
        });

		console.log("multiObjescts",multiObjescts);
        ob2 = multiObjescts;
        ...
        if (isOrderChanged == true || isNewOrder == true) {
            ...
            $.post('https://talknsave.net/wp-content/themes/betheme-child/MultiSaveApiResult.php', {
                    SaveApiData: data
                },
//                 function(msg) {
//                     // $(".loading").addClass('d-none');
...
// 						$(".popupDesc").append(msg.msg);
// 						openPopup('#wrap_popup1');
// //                         $(".order-review-error").removeClass('d-none');
// //                         $(".order-review-error-message").text(msg.msg);
// 					}
// // 				if (msg) {
...
//                 });
    ...
    function SummaryCreation(msg) {
        ...
        // 		}
        // Wartime Pop Up
        <?php if ($ifWartimePopup === "true") : ?>
                $(".popupTitle").empty();
                $(".popupDesc").empty();
                $(".popupTitle").text("Important Notice");
                $(".popupDesc").append("<div class='row mx-0'><div class='col-md-12 my-3'>Upon submitting your order, your account will be charged a one-time $18 + VAT setup fee. If the entire program is canceled, the full amount will be refunded to you.<br>However, individual cancellations are non-refundable.</div></div>");
                openPopup('#wrap_popup1');
            <?php endif; ?>
        $("#next9").click();

        var result = JSON.parse(msg);
        console.log(msg, result.data, "Summary Creation");
        ...
        $('#cc_fname').val = $('input[name="billing_fname"]').val();
        $('#paymentEmailAddress').val = $('input[name="billing_email"]').val();
        $('#credit_card').val = $('input[name="cc_number"]').val();

        console.log(121);
        console.log($('#credit-card').val());
        console.log(212);

        $('#cc_fname').text($('input[name="cc_fname"]').val());
        console.log($('input[name="cc_fname"]').val());
        $('#credit_card').text($('#credit-card').val());
        $('#expiry_date_review').text($('#expiry-date').val());
        $('#paymentEmailAddress').text($('#paymentEmail').val());
        $('#cardType').text($('#cardType').val());

        var card_info = $('#credit-card').val();
        console.log("info =" + $('#credit-card').val());

        var cc_fname = $('#cc_fname').parent().clone().html();
        var cc_type = $('#cardType').parent().clone().html();
        var paymentEmail = $('#paymentEmailAddress').parent().clone().html();
        var credit_card = $('#credit_card').parent().clone().html();
        var expiry_date = $('#expiry_date_review').parent().clone().html();


        var finalSummary = '<div class="content secondSummary"><div class="userDetails"><h4 style="margin-left:-15px">Contact information</h4><div class="row">' + userName + '</div><div class="row">' + userEmail + '</div><div class="row">' + userNumber + '</div></div> <div class="content secondSummary"><div class="userDetails"><h4 style="margin-left:-15px">Payment information</h4><div class="row">' + cc_fname + '</div><div class="row">' + paymentEmail + '</div><div class="row  ">' + credit_card + '</div> <div class="row">' + expiry_date + '</div></div>';
        var totalOfGrandTotal = 0;

        var hiddenNumber = 'x'.repeat(card_info.length - 4) + card_info.slice(-4);
        console.log(hiddenNumber);
        $(".checkout_credit_card_info").text(hiddenNumber);

        // 		$("#credit_card").closest(".checkout_credit_card_info").find("#credit_card").text(hiddenNumber); 
        // 		$(".checkout_credit_card_info #credit_card")[0].innerHTML =hiddenNumber; 
        var Covid_SignupFee = '<?php echo $isCovid_SignupFee ?>';
        var wrap_popup4 = false;
        $(allInvoices).each(function() {
            ...
            var allOneTimeFees = "";
            if (!wrap_popup4 && Covid_SignupFee > 0 && Covid_SignupFee == tblBills.GrandTotal_Online) {
                wrap_popup4 = true;
            }
            $(tblOndeTimefees).each(function() {
                ...
                if (crRecord.OnceFeeName == "Coupon Credit" || crRecord.OnceFeeName == "Coupon Code") {
                    ...
                    var feeName = crRecord.OnceFeeName == "Rental Fee" ? "Extension Fee" : (crRecord.Comment.indexOf("Europe Plan") !== -1) ? "Accessory" : crRecord.OnceFeeName == "Accessories" && <?php echo $isAnyEuropePlan ? 'true' : 'false'; ?> ? " Europe Plan" : crRecord.OnceFeeName;
                    allOneTimeFees += '<div class="row " style="padding-bottom: 13px"><div class="col-md-6 col-6">' + feeName + ' </div><div class="col-md-6 col-6 text-right ">' + amount + '</div></div>';
                }
            });
        ...
        if (wrap_popup4) {
            $(".popupTitle").empty();
            $(".popupDesc").empty();
            $(".popupTitle").text("Non Refundable Charge");
            $(".popupDesc").append("<div class='row mx-0'><div class='col-md-12 my-3'> Please be aware that a non-refundable charge of $6.99 will immediately be applied to your account, with the remaining balance billed on the start date of your program.<br>If you select any of our paid shipping options, the charge will be applied upon submitting your order.</div></div>");
            openPopup('#wrap_popup1');
        }
        ...
        // 			var hiddenNumber = 'x'.repeat(card_info.length - 4) + card_info.slice(-4);
        var hiddenNumber = 'xxxx-xxxx-xxxx-' + card_info.slice(-4);
...
// 					}
    ...
    function checkAndApplyCoupon() {
        var couponCodeInput = $("#coupanCode");
        if (couponCodeInput.val() !== "") {
            $(".applyCouponBtn").click();
            //     alert('applyCouponBtn')
        }
    }

    $('#coupanCode').on('input change ', function() {
    ...
    // Attach the click event handler to the "Apply Coupon" button
    $(".applyCouponBtn").click(function() {
        //     console.log('applyCouponBtnapplyCouponBtnapplyCouponBtn')
        ...
        if (couponVal == "") {
            ...
            $.ajax({
                url: "/wp-content/themes/betheme-child/MultiCouponCodeCheck.php?coupon=" +
                    couponVal +
                    "&b=" +
                    bundleID +
                    "&linkid=" +
                ...
                success: function(result) {
                    if (result == "invalid") {
                        $(".CouponCodeError")
                            .removeClass("d-none")
                            .empty()
                            .text("Coupon code is invalid or expired.");
                    } else {
                        var results = JSON.parse(result);
                        var isValid = false;
                        // Split the linkID string into an array of values
                        var linkIDArray = linkID.split(',');
                        for (let i = 0; i < results.length; i++) {
                            if (results[i].status == "valid") {
                                isValid = true;
                                // 				$.each(linkIDArray, function(index, value) {
                                // 				if (value.trim() === '17132' || value.trim() === '18265') {
                                // 					isValid = true;
                                // 				}
                                // 			});
                            }
                        ...
                        // Loop through the linkIDArray and check for matches
    ...
    // Attach a change event listener to the coupon code input
    // $("#coupanCode").on("input", checkAndApplyCoupon);
</script>
<script>
    // Wait for the document to be ready
    document.addEventListener("DOMContentLoaded", function() {
        // Get the input element
        var couponCodeInput = document.getElementById('coupanCode');

        // Check if the input field has a value
        if (couponCodeInput.value !== "") {
            // Trigger a click event on the input field
            document.getElementById('applyCouponBtnoncheckout').click();
    ...
    function checkImagesLoaded() {
        ...
        images.forEach(image => {
            if (!image.complete || image.naturalHeight === 0) {
                // If the image is not loaded, hide the image
                image.style.display = "none";
            }
        });
    }

    // Set a timeout to check images after 3 seconds
...
console.log(isSim+"-"+equipmentIDph);
                if ($(this).is(':checked') && isSim != "true" && (equipmentIDph == "3070" || equipmentIDph == "3160" || equipmentIDph == "3210" || equipmentIDph == "3300" || equipmentIDph == "3420")) {
					console.log("inif");
                    if ($(this).parent().find('.insurance-addon').length == 0) {
						console.log("length");
                        $(this).parent().append(`<div class="form-group mb-0 insurance-addon" style="background: #fff;border-radius: 6px;padding-top: 18px;"><div class="form-group row form-check mb-0" style="background: transparent;border: none;"><input class="form-check-input insurance-checkbox" type="checkbox" value=""><label class="form-check-label d-block check-label terms">Yes, Add Insurance at $2.50 + VAT per month</label></div><div class="form-group" style="padding-left: 32px;font-size: 14px;"><div class="input-group mb-2">Don't miss out add insurance  today and cover your phone for any damage!<br>* Does not include loss, theft or intentional damage. <br>In case of total loss, you will receive a $35 + VAT credit towards your phone replacement.</div></div></div>`);
                    }
                } else {
...
//         }
    ...
    function redirectToOldPage(linkId, bunId) {
        //window.location.href = "https://www.talknsave.us/signup_Page1.aspx?headerfooter=0&wordpress=1&b=" +
        //bunId + "&linkid=" + linkId;
        window.location.href = "https://www.talknsave.net/custom-multiple-checkout/?b" + bunId + "&linkid=" + linkId;
    }
</script>
