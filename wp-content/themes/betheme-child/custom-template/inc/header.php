    ...
    <div class="container">
        <div class="row">
            <div class="col-md-2 col-12 logo-container">
                <p style="word-spacing: -2px !important;">CALL US FOR HELP<br>1-866-825-5672  <br>02-655-0333</p>
                <div class="logo">
            ...
            <div class="col-md-5 col-12 info">
                <div class="info-container">
                    <table style=" border-spacing: 0; border-collapse: collapse; border-color:  #f2f2f2 !important; border-style: 1px solid #f2f2f2 !important">
                        <tr>
                            <td>Name</td>
                            <td align="right"><?php echo $general['ClientName']; ?></td>
                        </tr>
                        <tr>
                            <td>Phone Number</td>
                        ...
                        <tr>
                            <td>Equipment</td>
                            <td align="right"><?php echo $general['EquipmentModel']; ?></td>
                        </tr>
                        <tr>
                            <td>Plan Name</td>
            ...
            <div class="col-md-5 col-12 info border-0">
                <div class="info-container">
                    <table  style=" border-spacing: 0; border-collapse: collapse; border-color:  #f2f2f2 !important; border-style: 1px solid #f2f2f2 !important">
                        <tr>
                            <td>Invoice Date</td>
                            <td align="right"><?php echo date('M d, Y',strtotime(explode('T',$general['CreatedOn'])[0])); ?></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td>Address</td>
                            <td align="right"><?php echo $general['ClientStreet'].' '.$general['ClientCity'].' '.$general['ClientState'].' '.$general['ClientCountry'].', '.$general['ClientZip']; ?></td>
                        </tr>
                    </table>
                </div>
            </div>
