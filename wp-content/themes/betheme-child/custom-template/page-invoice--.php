    ...
    <main>
        <div class="container">
            ...
            <div class="row summary mb-4">
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-12 col-12 mx-0" style="display:flex; justify-content:space-between;">
                            <h3>Bill Summary</h3>
                              <div class="d-inline-block float-right">
                                <?php if(empty($_GET['pdfs'])): ?>
                                <a href="<?php echo home_url('/'); ?>invoice/?billid=<?php echo $_GET['billid'];?>&code=<?php echo $_GET['code']?>&pdf=1" style="color: #142454; font-style: 18px" download="talk-n-save<?=$_GET['billid']?>.pdf">
                                <img src="https://wordpress-944064-3284364.cloudwaysapps.com/wp-content/uploads/2022/09/free-pdf-download-icon-2617-thumb.png" alt="pdf" srcset="https://wordpress-944064-3284364.cloudwaysapps.com/wp-content/uploads/2022/09/free-pdf-download-icon-2617-thumb.png" heigth="30" width="30"></a>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
