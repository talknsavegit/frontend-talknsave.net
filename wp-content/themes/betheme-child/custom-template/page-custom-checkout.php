...
// 		$(clonePlanDetails).find('#cplan').attr('id',NewPlanID_D );
        ...
        $('#next8').click(function () {
            ...
            if (shippingAddress == 'yes' && billingCountry != shippingCountry) {
...
<?php endforeach; ?>	
    ...
    <div class="checkout-header">
        ...
        <div class="help-link"><a href="#">Customer Support <i class="icon-help-circled"></i></a></div>
    </div>
...
?>
                                This service is provided for minimum duration of <?php echo $min[0]; ?> <?php echo $minDayOrMonth; ?> and maximum duration of <?php echo $max[0]; ?> <?php echo $maxDayOrMonth; ?>
                            </p>
...
foreach ($equipments as $equipment):
    if ($equipment['IsSim'] == 1):
        ...
        <?php if ($equipment['EquipmentId'] == 2510) { ?>
                                                        <i class="icon-info-circled right-align cursorP" id="<?php echo $equipment['EquipmentId']; ?>" > </i>
                                <?php }
                                ?>
                                                </label>
                                            </div>
