            ...
            <div class="col-md-5 col-12 info">
                <div class="info-container">
                    <table style=" border-spacing: 0; border-collapse: collapse; border-color:  #f2f2f2 !important; border-style: 1px solid #f2f2f2 !important">
                        <tr>
                            <td>Name</td>
                            <td align="right" style="font-family:DejaVu Sans !important;"><?php echo $general['UserName']; ?></td>
                        </tr>
                        <tr>
                            <td>Phone Number</td>
            ...
            <div class="col-md-5 col-12 info border-0">
                <div class="info-container">
                    <table  style=" border-spacing: 0; border-collapse: collapse; border-color:  #f2f2f2 !important; border-style: 1px solid #f2f2f2 !important">
                        ...
                        <tr>
                            <td>Address</td>
                            <td align="right" style="font-family:DejaVu Sans !important;"><?php echo $general['ClientStreet'].' '.$general['ClientCity'].' '.$general['ClientState'].' '.$general['ClientCountry'].', '.$general['ClientZip']; ?></td>
                        </tr>
                    </table>
                </div>
            </div>
