    ...
    function AddInsuranceBox() {
        try {
            $('.equipmentSim').each(function() {
                ...
                if ($(this).is(':checked') && isSim != "true" && (equipmentIDph == "3070" || equipmentIDph == "3160" || equipmentIDph == "3210" || equipmentIDph == "3300")) {
...
<script>
    ...
    $(document).ready(function($) {
        ...
        $(document).on('click', '.next , #next2', function() {
            console.log("custom multiple checkout active page tempalte .next");
            total_forms = $("fieldset").length;
    ...
    async function submitMultiStepForm() {
        ...
        $('.serviceDateContainer').each(function() {
            ...
            $('.simCount').each(function(index) {
                ...
                if (simValue != "3290" && simValue != "3380" && simValue != "3390") {
                    esimValue++;
                }
            });
