...
if ($(element).attr("id") == "3290"  || $(element).attr("id") == "3380") {
...
function ValidateSimNum(element) {
  ...
  if (existing_phone.length == 17) {
    ...
    $.ajax({
      url:
        "https://www.talknsave.net/wp-content/themes/betheme-child/SimValidation.php?SimNumber=89972" +
        smNumber,
      type: "GET",
...
function AddSimInputBox(element) {
  ...
  var simInputHtml =
    '<div class="simNoclone mt-2"><div class="title" style="margin-bottom: 18px;"><h2>Enter Your 19 Digit SIM card <span class="simOrderNum"> </span></h2></div><div class="form-group"><div class="form-group"><div class="input-group mb-2"><div class="input-group-prepend" style="height: 57.5px;"><div class="input-group-text">89972</div></div><input type="text" name="existing_phone" style=" width:88%;border-left: 0px;border-radius: 0px;margin-bottom: 0px !important;" maxlength="17" class="existing_phone" placeholder="0000 0000 0000 0000 0"><p class="eSimNum" style="font-size:12px; color:red;  margin: 0px; "> </p><p class="simNoValue" style="font-size:12px; color:red;  margin: 0px; "> </p></div></div></div></div>';
