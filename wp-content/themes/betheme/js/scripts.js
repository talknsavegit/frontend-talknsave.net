(function($) {
  ...
  $(document).ready(function() {
	  ...
	  if(path=='monthly-rate-old' || path=='rental-multi'){
		  $('.HeaderCustomCart').css('display','block');
		  getOrderNumbersCount();
	  }
	  
	  $('.prepaid_order_container a').addClass('icon-month_rate-btn popmake-17066');
	  $('.prepaid_order_container a').click(
	  function(){
		  SetCheckoutWindow(this);
	  }
	  );
  ...
  function sliderTestimonials() {
	...
	$(".gw-go-col-wrap").addClass("parent");
