...
if (! function_exists('mfn_scripts')) {
	function mfn_scripts()
	{
		...
		wp_enqueue_script('mfn-scripts', get_theme_file_uri('/js/scripts.js?v=1.1.2'), array('jquery'), MFN_THEME_VERSION, true);
		//wp_enqueue_script('mfn-scripts', get_theme_file_uri('/js/CheckoutScript.js'), array('jquery'), MFN_THEME_VERSION, true);
