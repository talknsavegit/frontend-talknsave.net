...
<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-ZH6052LXBG"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());  gtag('config', 'G-ZH6052LXBG');
</script>
						...
						if( ! get_post_meta( mfn_ID(), 'mfn-post-hide-title', true ) ){
							...
							if (is_search()) {
								...
								if ($subheader_show) {
									...
									echo '<div id="Subheader" class="hidden">';
										echo '<div class="container">';
											echo '<div class="column one">';
