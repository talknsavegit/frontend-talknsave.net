...
if( $mfn_items_get && is_array($mfn_items_get) ){
    $mfn_items_get = call_user_func('base'.'64_encode', serialize($mfn_items_get));
}
        ...
        <div class="form-content form-content-full-width">
            <div class="form-group">
                <div class="form-control">
                    <textarea class="mfn-form-control mfn-export-field mfn-form-textarea">'.$mfn_items_get.'</textarea>
                </div>
            </div>
        </div>
    </div>
