...
// $CartHtml= '<a id="header_cart" class="popmake-17066" onclick="OpenCart(this,0,0,false);"><i class="'. $show_cart .'"></i></a>'; 
// echo '<div class="top_bar_right"><div class="top_bar_right_wrapper 1">'.$CartHtml.'</div></div>';
