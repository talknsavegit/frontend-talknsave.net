			...
			<div class="one clearfix">
				...
				<div class="top_bar_left">
					...
					<div class="menu_wrapper">
						...
						echo '<div class="header_cart HeaderCustomCart  popmake-17653" style="text-align: center;" onclick="OpenCart(this, 0, 0, false)"><i class="fa fa-shopping-cart" style="font-size: 34px;cursor: pointer;" title="My Cart"><span class="cartOrderNumbersCount" style="color: #9a051a;background-color: #bae1e9;font-size: 18px;font-weight: bold;position: absolute;bottom: 15px;border-radius: 9px;width: 21px;left: 20px;">0</span></i></div>';
